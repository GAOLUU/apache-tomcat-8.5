...
public class Catalina {
    ...
    protected Digester createStartDigester() {
        ...
        // 设置相应的节点解析规则
        // addObjectCreate:碰到xml文件中的Server节点则创建一个StandardServer
        digester.addObjectCreate("Server",
                                 "org.apache.catalina.core.StandardServer",
                                 "className");
        // addSetProperties:根据Server节点中的属性信息调用相应属性的setter方法，会调用setPort、setShutdown方法，入参分别是8005、SHUTDOWN
        digester.addSetProperties("Server");
        // addSerNext:将Server节点对应的对象作为入参调用栈顶对象的setServer方法，这里的栈顶对象即下面的digester.push方法所设置的当前类的对象this
